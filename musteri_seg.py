...
print("Veri Setinin İlk 5 Örneği: \n", df.head(5))
print("Veri Setinin Şekli: \n", df.shape)
...
print("--- Veri Yüklendi, Gender Düzeltildi, Aykırı Değerler Temizlendi ---")
...
plt.title('Silhouette Skor Karşılaştırması (Büyük olması daha iyi)')
...
plt.title('Davies-Bouldin Skor Karşılaştırması (Küçük olması daha iyi)')
...
print(f"\nSilhouette Skorları: {skorlar_sil}")
print(f"Davies-Bouldin Skorları: {skorlar_db} içermektedir.")
